...
<body>
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
      <a href="/" class="d-flex align-items-center link-body-emphasis text-decoration-none">
        ...
        <span class="fs-4" style="margin: 20px;">Система управления заявками</span>
      </a>
      ...
      <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
        ...
        <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="/request_type_choice">Отправить заявку</a>
        <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="/request_show_choice">Просмотреть список заявок</a>
        <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="/report">Отчёты</a>
        <a class="me-3 py-2 link-body-emphasis text-decoration-none" href="/equipment_show">Оборудование</a>
